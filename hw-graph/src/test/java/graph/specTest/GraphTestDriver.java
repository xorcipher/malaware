...
public class GraphTestDriver {
    ...
    private static void printUsage() {
        ...
        System.err.println("  To read from a file: java graph.graph.specTest.GraphTestDriver <name of input script>");
        System.err.println("  To read from standard in (interactive): java graph.graph.specTest.GraphTestDriver");
    }
    ...
    private void addNode(String graphName, String nodeName) {
        ...
        boolean res = g.add(nodeName);
        if (res) {
            output.println("added node " + nodeName + " to " + graphName);
        } else {
            output.println("node " + nodeName + " already exists in " + graphName);
        }
    }
    ...
    private void listNodes(String graphName) {
        ...
        output.println("graph " + graphName + " contains:" + nodeSetToString);
    }
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        for (String node : g.getChildren(parentName)) {
            for (String label : g.getEdges(parentName, node)) {
                sortedEdges.add(node + "(" + label + ")");
            }
        }
        Collections.sort(sortedEdges);
        String result = sortedEdges.toString();
